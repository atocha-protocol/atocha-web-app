    ...
    <div>
      <div className="ui two column stackable grid">
        <div className="ten wide column">
          ...
          {arPuzzleAnswerFormat?<div style={{marginBottom:"1rem"}}>Auto-generated answer format&nbsp;&nbsp;<i style={{cursor:"pointer"}} className="question circle outline icon" title="Auto-generated by App, the creator can not edit it."></i>: <strong>{arPuzzleAnswerFormat}</strong></div>:""}
